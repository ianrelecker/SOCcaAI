...
def main():
    ...
    print("2. python kryptos_working/hourlyreportgen.py  (Report Generator)")
    print("3. python kryptos_working/sentinel_exporter.py --direct-send  (Microsoft Sentinel Integration)")
